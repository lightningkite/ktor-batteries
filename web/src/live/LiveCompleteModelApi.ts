...
export namespace LiveCompleteModelApi {
    ...
    export class Companion {
        ...
        public create<Model extends HasId<string>>(Model: Array<any>, root: string, multiplexSocketUrl: string, path: string, token: (string | null), headers: Map<string, string> = new Map([])): LiveCompleteModelApi<Model> {
